...
class AppState {
    ...
    http_handleResponses(obj) {
        ...
        if ("config" in obj) {
            ...
            } else if (!config_fetched && "gm-used" in config && !("cu" in config)) {
                tfmcu_config = Object.assign(tfmcu_config, config);
                usedMembers_fromConfig();
                console.log("tfmcu_config", tfmcu_config);
