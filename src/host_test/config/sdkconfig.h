...
#define CONFIG_APP_TCPS_ENABLE 0
...
#define CONFIG_TRONFERNO_TRX_DEBUG 1
#define CONFIG_TRONFERNO_PUBLISH_PCT_AS_TXT 1
#define CONFIG_TRONFERNO_PUBLISH_TRX_AS_TXT 1
#define CONFIG_FERNOTRON_UOUT_DEBUG 1
