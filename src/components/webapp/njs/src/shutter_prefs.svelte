...
<div id="shprefdiv">
  ...
  <table class="dur_table top_table p-2">
    ...
    <tr><td>{$_('app.upTo100')}</td><td><input class="w-20" id="shpMvut" type="number" min="0" bind:value="{mvut}" step="0.1"></td><td><button id="shp_MvutButton" on:click={hClick_Up}>Start/Stop</button></td></tr>
    <tr><td>{$_('app.downToZero')}</td><td><input class="w-20" id="shpMvdt" type="number" min="0" bind:value="{mvdt}" step="0.1"></td><td><button id="shp_MvdtButton" on:click={hClick_Down}>Start/Stop</button></td></tr>
    <tr><td>{$_('app.downSunPos')}</td><td><input class="w-20" id="shpSpMvdt" type="number" min="0" bind:value="{mvspdt}" step="0.1"></td><td><button id="shp_SpMvdtButton" on:click={hClick_Sun}>Start/Stop</button></td></tr>
  </table>
