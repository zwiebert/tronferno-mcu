...
constexpr unsigned FER_PRE_WIDTH_MAX_US = 6 * 200;
constexpr unsigned FER_PRE_WIDTH_MIN_US = 3 * 200;
constexpr unsigned FER_PRE_NEDGE_MIN_US = 1 * 200;
constexpr unsigned FER_PRE_NEDGE_MAX_US = 4 * 200;
