...
bool fer_sep_authenticate(class UoutWriter &td, uint32_t auth_key, int auth_timeout_secs = SEP_AUTH_TIMEOUT_SECS, int button_timeout_secs =
 ...
 */
bool fer_sep_enable(class UoutWriter &td, uint32_t auth_key, uint32_t a, uint8_t g = 0, uint8_t m = 0, int enable_timeout_secs = fer_sep_TIMEOUT, int button_timeout_secs =
