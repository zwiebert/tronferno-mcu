...
const en = {
  app: {
    ...
    upTo100: "up to 100%",
    setMode: {
      set_button: "Press Set-Button on Receiver first. Then press this button.",
      set_button_radio: "Set-Button",
...
const de = {
  app: {
    ...
    setMode: {
      set_button: "Set-Knopf am Empfängergerät zuerst drücken. Dann diesen Knopf klicken.",
      set_button_radio: "Set-Knopf",
