...
#define DL
#endif
#define logtag "tf.cli.parm_shpref"
...
static void output_message_kvs(class UoutWriter &td, const char *tag, const char *val) {
...
static void output_message_kvd(class UoutWriter &td, const char *key, int val) {
